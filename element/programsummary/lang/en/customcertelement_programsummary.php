...
$string['pluginname'] = 'Program Summary';
$string['privacy:metadata'] = 'The mainsectionname plugin does not store any personal data.';
$string['programsummary'] = 'Program Summary';
$string['programsummary_help'] = 'This will display all of the curso names as a bulleted list';
$string['program_contains'] = 'Composed of the courses:';
